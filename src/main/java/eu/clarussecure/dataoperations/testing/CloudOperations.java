...
public class CloudOperations {
    ...
    // private static BigDecimal calculateDistance(DBRegister point1, DBRegister
    // point2)
    // {
    // return
    // sqrt(point2.getX().subtract(point1.getX()).pow(2).add(point2.getY().subtract(point1.getY()).pow(2)));
    // }
}
